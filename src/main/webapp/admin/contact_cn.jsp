...
<head>
    ...
    <script type="text/javascript" src="/js/admin/contact_cn.js"></script>
</head>
...
<!-- DataList end -->
<!-- Edit Form -->
<div id="edit-win" class="easyui-window" title="产品信息修改" data-options="closed:true,iconCls:'icon-edit',modal:false,fit:true,zIndex:-100">
    <%-- 图片上传form--%>
