...
<head>
    ...
    <script type="text/javascript" src="/js/admin/applyFlow_cn.js"></script>
</head>
...
<%--<div class="ui-search-panel" region="north" style="height: 80px;" title="搜索框"
    ...
    <form id="searchForm">
        <p class="ui-fields">
            ...
            <input name="name" id="Sname" class="easyui-box ui-text" style="width:100px;">&nbsp;&nbsp;&nbsp;
        </p>
...
<!-- DataList end -->
<!-- Edit Form -->
<div id="edit-win" class="easyui-window" title="申请流程信息修改" data-options="closed:true,iconCls:'icon-edit',modal:false,
fit:true,draggable:false,collapsible:false,minimizable:false,maximizable:false,closable:false">
    <%-- 图片上传form--%>
